...
export const GithubOutlineIcon = ({ className, ...props }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    x='0px'
    y='0px'
...
export const LinkedInOutlineIcon = ({ className, ...props }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    x='0px'
    y='0px'
...
export const PintepropsIcon = ({ className, ...props }: IconProps) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    width='1em'
    height='1em'
...
export const DownloadIcon = ({ className, ...props }: IconProps) => (
  <svg
    ...
    fill='none'
    xmlns='http://www.w3.org/2000/svg'
    className={`w-6 h-6 text-current ${className}`} // Ensure `text-current` is added
    {...props}
  >
    <path
